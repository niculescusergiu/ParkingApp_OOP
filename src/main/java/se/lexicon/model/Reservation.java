...
public void create() {
        if (parkingSpot == null) throw new IllegalArgumentException("ParkingSpot cannot be null.");
    if (associatedVehicle == null) throw new IllegalArgumentException("AssociatedVehicle cannot be null.");
